...
public class ComprarProdutoSteps {
	...
	public static void inicializar() {
		System.setProperty("webdriver.chrome.driver", "/home/kleber/webdrivers/chromedriver/86/chromedriver");
	...
	public void que_estou_na_pagina_inicial() {
	   ...
	   assertThat(homePage.obterTituloPaginaPrincipal(), is("Loja de Teste"));
	}
	...
	public void adiciono_o_produto_no_carrinho_com_tamanho_cor_e_quantidade
	(String tamanhoProduto, String corProduto, Integer quantidadeProduto) {
	    ...
	    if(!corProduto.equals("N/A")) produtoPage.selecionarCorPreta();
	...
	public void o_produto_aparece_na_confirmacao_com_o_nome_preco_tamanho_e_quantidade
	(String nomeProduto, String precoProduto, String tamanhoProduto, String corProduto, Integer quantidadeProduto) {
	    ...
	    if(!corProduto.equals("N/A")) assertThat(modalProdutoPage.obterCorProduto(), is(corProduto));
